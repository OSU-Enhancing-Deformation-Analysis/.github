...
This program uses the OpenCV image library to detect cracks in materials. The algorithm aids with out material preprocessing and grouping our data. It is useful for excluding areas when doing the Digital Image correlation to create better motion maps and strain results.
